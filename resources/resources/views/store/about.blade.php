...
<div class="container mx-auto px-4 py-8 max-w-6xl space-y-12">
    ...
    <div class="text-center max-w-3xl mx-auto space-y-4">
        ...
        <h1 class="text-3xl md:text-5xl font-black text-slate-900 tracking-tight">
            {{ $settings->about_title ?: 'Tentang RumahKeramik' }}
        </h1>
    ...
    <div class="grid md:grid-cols-12 gap-8 items-center bg-white rounded-3xl p-6 md:p-10 border border-slate-200 shadow-sm">
        <div class="md:col-span-6 rounded-2xl overflow-hidden shadow-lg border border-slate-100">
            <img src="{{ $settings->about_image ?: 'https://images.unsplash.com/photo-1578749556568-bc2c40e68b61?auto=format&fit=crop&w=1000&q=80' }}" alt="Galeri RumahKeramik" class="w-full h-80 md:h-96 object-cover">
        </div>
    ...
    <div class="bg-gradient-to-r from-slate-900 via-slate-800 to-indigo-950 text-white rounded-3xl p-8 md:p-12 text-center space-y-6 shadow-xl border border-slate-800">
        ...
        <div class="flex justify-center gap-4 pt-2">
            <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $settings->whatsapp_number) }}?text=Halo%20RumahKeramik,%20saya%20ingin%20berkonsultasi." target="_blank" class="inline-flex items-center gap-2 bg-emerald-500 hover:bg-emerald-600 text-white font-bold text-sm px-6 py-3.5 rounded-2xl shadow-lg transition-all">
