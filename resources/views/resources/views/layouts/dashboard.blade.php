...
<head>
    ...
    <title>@yield('page_title', 'Dashboard') — RumahKeramik</title>
...
<aside class="sidebar" id="sidebar">
    ...
    <a href="{{ route('store.index') }}" class="sidebar-brand">
        ...
        <div class="sidebar-brand-text">
            <div class="sidebar-brand-name">Rumah<span>Keramik</span></div>
...
<div class="topbar" id="topbar">
    <div class="topbar-left">
        ...
        <div>
            ...
            <div class="topbar-breadcrumb" id="topbarBreadcrumb">RumahKeramik / @yield('page_title', 'Dashboard')</div>
        </div>
    </div>
