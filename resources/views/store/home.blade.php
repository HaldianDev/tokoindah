...
<div class="space-y-16 pb-12">
    ...
    <div class="container mx-auto px-4 max-w-7xl">
        ...
        <div class="mt-8 text-center sm:hidden">
            <a href="{{ route('store.index') }}" class="inline-flex items-center justify-center w-full px-6 py-3 text-sm font-bold text-white transition-all duration-200 rounded-2xl shadow-lg bg-sky-600 hover:bg-sky-700">
                Lihat Semua Katalog ({{ $totalProducts }}) <i class="fa-solid fa-arrow-right text-xs ml-2"></i>
            </a>
        </div>
    </div>
