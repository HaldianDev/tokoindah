                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align:center;">
                            @if($ord->ktp_path)
                                <button onclick="openKtpModal('{{ asset('storage/' . $ord->ktp_path) }}', '{{ $ord->customer_name }}')" class="btn-action btn-sm" style="background:#0EA5E9;color:#fff;padding:4px 10px;border-radius:6px;font-size:0.75rem;border:none;cursor:pointer;display:inline-flex;align-items:center;gap:4px;">
